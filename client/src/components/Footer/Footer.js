...
const navigation = {
  solutions: [
    { name: 'Marketing', href: '#=3' },
    { name: 'Analytics', href: '#w=' },
    { name: 'Commerce', href: '#w=' },
    { name: 'Insights', href: '#s' },
  ],
  support: [
    { name: 'Pricing', href: '#aj' },
    { name: 'Documentation', href: '#a' },
    { name: 'Guides', href: '#aq' },
    { name: 'API Status', href: '#ad' },
  ],
  company: [
    { name: 'About', href: '#qfg' },
    { name: 'Blog', href: '#qe3' },
